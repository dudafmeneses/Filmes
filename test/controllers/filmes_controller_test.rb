...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { ano: @filme.ano, descricao: @filme.descricao, nome: @filme.nome } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { ano: @filme.ano, descricao: @filme.descricao, nome: @filme.nome } }
